...
def parsing():
    with open(f'data_test.csv', "w", errors='ignore', encoding="utf-8") as file:
        ...
        headers = ('url', 'name_company', 'www_company', 'telephone_company', 'address', 'street_address',
        ...
        urls = [
            'https://www.houzz.com/professionals/interior-designers-and-decorators/by-design-interiors-inc-pfvwus-pf~847618990',
            'https://www.houzz.com/professionals/interior-designers-and-decorators/urbanology-designs-pfvwus-pf~1132822062'
        ]
        for i in urls[:1]:
            emails = set()
