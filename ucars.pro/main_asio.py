...
async def process_link(link):
    ...
    #                     pass
        ...
        if auction == 'Copart':
            ...
            values = {
                'price': price, 'vin': vin, 'title': title, 'number': number, 'auction': auction, 'country': country,
                'branch': branch, 'dealer': dealer, 'pos': pos, 'date': date, 'time': time, 'docks': docks,
                'loss': loss,
                'crush': crush, 'second_crush': second_crush, 'state': state, 'odometer': odometer, 'retail': retail,
                'fix': fix, 'type_auto': type_auto, 'year': year, 'mark': mark, 'model': model, 'color': color,
                'body': body, 'drive': drive, 'fuel': fuel, 'engine': engine, 'transmission': transmission
            }
