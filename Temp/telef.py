...
def get_content(url):
    ...
    try:
        ...
        product_url = []
        brand_samsung = driver.find_element(By.XPATH, '//div//a[text()="Samsung"]').click()
        driver.implicitly_wait(5)
        cards_url = driver.find_elements(By.XPATH, '//div[@class="model-listing-container-80"]//div[contains(@id, "model")]/a')
        for href in cards_url[1:]:
            url_card = href.get_attribute("href")
            print(url_card)
