...
my_proxy = {
    "http": "http://FVWBTUxw:mCPK5MqY@46.150.240.98:49774/",
    "https": "http://FVWBTUxw:mCPK5MqY@46.150.240.98:49774/"
}
...
def write_in_csv(url, page):
    for _ in range(2):
        try:
            with get('http://api.scraperapi.com', proxies=my_proxy, params={'api_key': api_key,
