...
# Данные для прокси
PROXY_HOST = '45.9.238.34'
PROXY_PORT = 2831 #Без кавычек
PROXY_USER = '32833'
PROXY_PASS = 'JBybfvJHBhdd3'
...
def get_chromedriver(use_proxy=False, user_agent=None):
    ...
    s = Service(
        executable_path="D:\\Парсер\\dok.ua\chromedriver.exe"
    )
...
def get_undetected_chromedriver(use_proxy=False, user_agent=None):
    ...
    s = Service(executable_path="D:\\Парсер\\dok.ua\chromedriver.exe")
...
def save_link_all_product(url):
    ...
    for item_prod in pod_categoriy_product_urls:
        ...
        for page in range(1, pagan + 1):
            ...
            with open(f"D:\\Парсер\\dok.ua\\link\\{group_product}.json", 'a') as file:
        ...
        if block_all_price:
            ...
            for href in table_price:
                ...
                try:
                    ...
                    n_11 = 'No n_11'
                with open(f"D:\\Парсер\\dok.ua\\data\\datas.csv", "a", errors='ignore') as file:
