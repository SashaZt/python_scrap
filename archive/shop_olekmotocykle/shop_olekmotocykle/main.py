...
cookies = {
    'isMobileDevice': '0',
    '.cdneshopsid': 'qyf3ftsWHDkCCEMAWo84B5PBRfA37UPj1r5BqLgIC0HwtT9qXGLaGvPtNx7JyG10P4JEPs3+gjg1PpYHoQ|004',
    'lastCartId': '-1',
    'config-message-052fd829-3229-4b96-a597-13e6f2ebee5f': 'hidden',
    'undefined': 'hidden',
    'LastSeenProducts': '69341,55172,83783,107614,136492,180377',
}
...
headers = {
    ...
    # 'Cookie': 'isMobileDevice=0; .cdneshopsid=qyf3ftsWHDkCCEMAWo84B5PBRfA37UPj1r5BqLgIC0HwtT9qXGLaGvPtNx7JyG10P4JEPs3+gjg1PpYHoQ|004; lastCartId=-1; config-message-052fd829-3229-4b96-a597-13e6f2ebee5f=hidden; undefined=hidden; LastSeenProducts=69341,55172,83783,107614,136492,180377',
    'DNT': '1',
    'Pragma': 'no-cache',
...
def parsing_url_category_in_html():
    ...
    response = requests.get(url, cookies=cookies, headers=headers, proxies=proxi)  # , proxies=proxies
            ...
            for u in urls_photo:
                ...
                if len(urls_photo) == 1:
                    if not os.path.exists(file_path_1):
                        try:
                            img_data = requests.get(u, cookies=cookies, headers=headers, proxies=proxi)
