...
def parsing():
    ...
    with open('output.csv', 'w', newline='', encoding='utf-8') as file, open('exist_data.csv', 'w', newline='',
                                                                             encoding='utf-8') as exist_file:
        writer = csv.writer(file, delimiter=";")
        exist_writer = csv.writer(exist_file, delimiter=";")  # Создаем writer для exist.csv
        exist_writer.writerow(['brand', 'sku', 'price_old'])  # Записываем заголовок для exist.csv
